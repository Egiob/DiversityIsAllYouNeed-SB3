...
class DIAYNDiscretePolicy(DIAYNPolicy):
    ...
    def __init__(
        ...
        assert isinstance(action_space, gym.spaces.Discrete), f"You called Discrete policy, but the input action space is {action_space}."
        super(DIAYNDiscretePolicy, self).__init__(
            observation_space,
            action_space,
            lr_schedule,
            prior,
...
MlpDiscretePolicy = DIAYNDiscretePolicy


class CnnDiscretePolicy(DIAYNDiscretePolicy):
    def __init__(
        self,
        observation_space: gym.spaces.Space,
        action_space: gym.spaces.Space,
        ...
        super(CnnDiscretePolicy, self).__init__(
            observation_space,
            action_space,
            lr_schedule,
            prior,
...
class MultiInputDiscretePolicy(DIAYNDiscretePolicy):
    ...
    def __init__(
        ...
        super(MultiInputDiscretePolicy, self).__init__(
            observation_space,
            action_space,
            lr_schedule,
            prior,
...
register_policy("MlpDiscretePolicy", MlpDiscretePolicy)
register_policy("CnnDiscretePolicy", CnnDiscretePolicy)
register_policy("MultiInputDiscretePolicy", MultiInputDiscretePolicy)
...
class DiscreteActor(BasePolicy):
    ...
    def __init__(
        ...
        self.action_dist = make_proba_distribution(
            action_space, use_sde=use_sde, dist_kwargs=None
        )
    ...
    def forward(self, obs: th.Tensor, deterministic: bool = False) -> th.Tensor:
        ...
        distrib       = self.action_dist.proba_distribution(action_logits=action_logits)
        actions       = distrib.get_actions(deterministic=deterministic)
