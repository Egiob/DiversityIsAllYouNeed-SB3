...
from stable_baselines3.common.type_aliases import ReplayBufferSamples, RolloutBufferSamples, ReplayBufferSamplesZ
...
class ReplayBufferZ(BaseBuffer):
    ...
    def __init__(
        ...
        super(ReplayBufferZ, self).__init__(buffer_size, observation_space, action_space, device, n_envs=n_envs)
